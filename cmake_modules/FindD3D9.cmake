...
if (WIN32)
    ...
    # httppublic.kitware.compipermailcmake-developers2014-October023190.html
    ...
    if (DirectX_ROOT_DIR)
        ...
        set (DirectX_BIN_SEARCH_PATH ${DirectX_ROOT_DIR}Utilitiesbinx86)
    endif ()
    ...
    #
    # See also
    # - httpmsdn.microsoft.comen-uslibrarywindowsdesktopee663275.aspx
    if (MSVC)
    ...
    if (MSVC)
        set (DirectX_D3D8_INCLUDE_DIR ${CMAKE_SOURCE_DIR}thirdpartydxsdk_aug2007)
    ...
    find_winsdk_header  (XAudio2 xaudio2.h)
